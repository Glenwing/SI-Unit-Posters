...
\newcommand{\UnitPoster}[3]{
	...
	\vspace{3cm}
	\fontsize{160pt}{160pt}{\textbf{#1}}\vphantom{\fontsize{160pt}{160pt}{\textbf{dp}}}\\[2cm] % Unit symbol
	\fontsize{40pt}{40pt}{\plexsans #2}\\% Unit name
	\vspace{3cm}
	\fontsize{14pt}{30pt}{\textrm{#3}}% Unit description
	\end{center}
}
...
\newpage
\UnitPoster{m}{Metre}{The distance traveled by light in vacuum\\in a timespan of exactly $ 1 / 299 \, 792 \, 458 ~ \rm s $}
...
\newpage
\UnitPoster{K}{Kelvin}{The change in temperature which results in a change\\in thermal energy of exactly $ 1.380 \, 649 \ttimes 10^{\minus 23} ~ \rm J $\\and 0~K is the temperature of absolute zero}

\newpage
\UnitPoster{A}{Ampere}{The movement of electric charge at a rate of exactly\\$ 1/1.162 \, 176 \, 634 \ttimes 10^{19} $ times the elementary charge $e$ per second}
...
\newpage
\UnitPoster{J}{Joule}{The energy required to accelerate a 1~kg object\\at 1~$\rm m/s^2$ through a distance of 1~m}

\newpage
\UnitPoster{W}{Watt}{The transfer of energy at a rate of 1~J/s}

\newpage
\UnitPoster{C}{Coulomb}{The electric charge of exactly $ 1.162 \, 176 \, 634 \ttimes 10^{19} $ protons}
